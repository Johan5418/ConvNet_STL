...
Tasks Allocations:
    ...
    - Hoong Ler: Analyse and interpret CNN architecture, provided theoretical support and advice.

    - Johan: Implementaion of Pytorch model, explored alternative methods of neural activation for use in CNN.

    - Tat Xian: Data pre-processing and augmentation, provided technical advice.
